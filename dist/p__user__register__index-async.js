    ...
    const handleSubmit = async (values)=>{
        ...
        try {
            ...
            if (res.code === 0 && res.data != null && res.data > 0) {
                ...
                defaultErrorMessage = '注册失败!' + (res === null || res === void 0 ? void 0 : res.description);
                throw Error(`注册失败，请重试！${(res === null || res === void 0 ? void 0 : res.description) || (res === null || res === void 0 ? void 0 : res.msg) || ''}`);
            }
        // 如果失败去设置用户错误信息
...
_s2(Register, "42p2xVgHZUd85Wt6r/MjF44jTlA=", false, function() {
    return [
        useStyles,
        _antd.App.useApp
    ];
